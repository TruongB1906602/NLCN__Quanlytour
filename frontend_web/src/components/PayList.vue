         ...
         <div class=" row-cols-1">
          ...
          <div class=" row-cols-1" >
            ...
            >
             ...
             <!-- <div class=" row-cols-1" >
             <h4 class="heading">Thông tin khác</h4>
            <div  class="others" v-for="pay in pays"
                :key="pay._id"
               
            >
                <span>{{pay.others}}</span></div>
            ...
            <div  class="btn list-group-item pay-item d-flex" v-for="(pay, index) in pays"
                ...
                :key="pay._id"
                @click="updateActiveIndexPay(index)"
               
            >
              <button class=" btn-outline-danger btn-sm" @click="delpay(pay._id)"><ion-icon name="close-circle-outline"></ion-icon></button>
               <button class=" btn-outline-danger btn-sm" @click="updateActiveIndexPay(pay._id)"><i class="fa-solid fa-folder-plus"></i></button>
               </div>
            </div>
    </div>
     </template>
