         ...
         <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
               <div class="d-flex align-items-center">
                  <img
                     @click="show"
                     style="width: 21px; height: 24px; margin-right: 5px"
                     ...
                     <div class="list_hotels" v-if="currentBlock == 1">
                        ...
                        <div class="list_item_product d-flex" id="product">
                           <ListHotel
                              :hotels="hotels"
                              :refeshlist="getall"
                              :getindexhotels="getindexhotels"
                              v-model:activeIndex1="activeIndex1"
                           >
                           </ListHotel>
                           <div
                     ...
                     <div class="tour" v-else-if="currentBlock == 5">
                        ...
                        <div class="list_item_product d-flex" id="product">
                           <ListOrder
                              :orders="orders"
                              :refeshlist="getall"
                              :getindexorder="getindexorder"
                              v-model:activeIndexOrder="activeIndexOrder"
                           >
                           </ListOrder>
                        </div>
                     </div>
                     ...
                     <div class="list_products" v-else>
                        ...
                        <div class="list_item_product d-flex" id="product">
                           <PayList
                              :pays="pays"
                              :refeshlist="getall"
                              :getindexpay="getindexpay"
                              v-model:activeIndexPay="activeIndexPay"
                           >
                           </PayList>
